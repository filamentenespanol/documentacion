...
### Generar automáticamente columnas del importador
...
## Definir columnas del importador
...
### Personalizar la etiqueta de una columna de importación
...
### Requerir una columna del importador to be mapped to a CSV column
...
### Manejar múltiples valores in a single column
